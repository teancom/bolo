...
B<bolo name> dump  QUALIFIED-NAME [...]
...
Prints debugging information from the I<qname> parser, which can be useful
to developers and system integrators wishing to understand qualified names
on a deeper level, and chase down bugs in the implementation.
